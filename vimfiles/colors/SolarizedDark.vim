...
" Generated by http://bytefluent.com/vivify 2017-10-12
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi SignColumn guifg=#839496 guibg=#074242 guisp=#073642 gui=NONE ctermfg=66 ctermbg=7 cterm=NONE
...
" Search
hi Search guifg=#f9f9ff guibg=#bd9700 guisp=#00ffff gui=NONE ctermfg=136 ctermbg=14 cterm=NONE
hi IncSearch guifg=#cb4b16 guibg=#00ffff guisp=NONE gui=NONE ctermfg=166 ctermbg=NONE cterm=NONE
...
" visual mode
hi Visual guifg=#0a0a0a guibg=#ad8b26 guisp=#002b36 gui=NONE ctermfg=66 ctermbg=23 cterm=NONE
...
" Cursor
hi Cursor guifg=#002b36 guibg=#00efff guisp=#839496 gui=NONE ctermfg=23 ctermbg=66 cterm=NONE
